...
<head id="head1" runat="server">
	...
	<title>Grid: WebService Running Mode</title>
...
<form id="form1" runat="server">
	<Demos:Header RunAt="server" Id="DemoHeader" DemoTitle="Grid: WebService Running Mode" />
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <ComponentArt:Grid id="Grid1"
        ...
        AllowGrouping="true"
        Width="700" Height="440" runat="server">
        <Levels>
