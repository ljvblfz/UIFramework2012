...
<head id="head1" runat="server">
	...
	<title>Grid: Simple Loading from SOA.UI</title>
...
<form id="form1" runat="server">
	<Demos:Header RunAt="server" Id="DemoHeader" DemoTitle="Grid: Simple Loading from SOA.UI" />
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <ComponentArt:Grid id="Grid1"
        ...
        PreHeaderClientTemplateId="PreHeaderTemplate"
        PostFooterClientTemplateId="PostFooterTemplate"
        ...
        AllowGrouping="true"
        Width="700" Height="415" runat="server">
        <Levels>
