...
namespace ComponentArt.WinUI
{
	...
	class Button : System.Windows.Forms.Button
	{
		...
		*/
		...
		//[Browsable(false), EditorBrowsable(EditorBrowsableState.Never)]
		//[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		//[DefaultValue(typeof(Font), "Verdana, 11px")]
		...
		void DrawDown() 
		{
			DrawButton(ref m_downImage, Color.FromArgb(255, 51, 0), Color.FromArgb(221, 52, 59), Color.FromArgb(204, 204, 204), Color.White, m_downIcon, m_iconLocation);
		}
		...
		protected override void OnMouseDown ( System.Windows.Forms.MouseEventArgs mevent )
		{
			m_pressed = true;
			/*
			base.BackgroundImage = Skin.GetBackgroundWithBorderImage(this, m_pressed);
			*/
		...
		protected override void OnBackColorChanged (EventArgs a)
		{
			GenerateButtonImages();
		}
		/*
		...
		*/
		...
		protected override void OnPaint ( System.Windows.Forms.PaintEventArgs e )
		{
			...
			g.DrawImageUnscaled((m_pressed || m_depressed) ? m_downImage : (m_over || Focused) ? m_hoverImage : (!Enabled) ? m_disabledImage : m_normalImage, 0, 0);
		}
		...
		protected override void OnMouseEnter ( System.EventArgs eventargs ) 
		{
			...
			m_over = true;
			Invalidate();
			//base.BackgroundImage = m_over ? m_overBackgroundImage : m_normalBackgroundImage;
		}
		...
		private bool m_depressed = false;
		[DefaultValue(false)]
