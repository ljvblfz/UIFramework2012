...
namespace ComponentArt.Web.Visualization.Gauges.Core.WinUI
{
	...
	internal
#endif
		class ColorStopControl : System.Windows.Forms.UserControl
	{
		private ComponentArt.WinUI.Button buttonColorDialog;
		private System.ComponentModel.IContainer components;

		private ColorStop colorStop;
		...
		public ColorStopControl()
		{
			// This call is required by the Windows.Forms Form Designer.
			colorStop = new ColorStop(0,Color.Empty);
			InitializeComponent();
			DoControlLayout();

			toolTip1.SetToolTip(buttonDelete,"Delete color stop");
		...
		private void InitializeComponent()
		{
			...
			this.textBoxPosition.Text = "0.000";
		...
		private void buttonColorDialog_Click(object sender, System.EventArgs e)
		{
			...
			{
				ColorStop = new ColorStop(colorStop.Position,dlg.Color);
				if(OnChange != null)
		...
		private void textBoxColor_Leave(object sender, System.EventArgs e)
		{
			...
			{
				this.ColorStop = new ColorStop(colorStop.Position,color);
				if(OnChange != null)
					OnChange(this,EventArgs.Empty);
			}
		}
		...
		public ColorStop ColorStop
		{
			...
			set
			{
				...
				this.textBoxPosition.Text = colorStop.Position.ToString("0.00##");
			}
		}
	}
}
