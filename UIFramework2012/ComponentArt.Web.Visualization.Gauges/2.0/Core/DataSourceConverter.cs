...
namespace ComponentArt.Web.Visualization.Gauges
{
	...
	internal class DataSourceConverter : ReferenceConverter
	{
		...
		public override TypeConverter.StandardValuesCollection GetStandardValues(ITypeDescriptorContext context)
		{
			...
			TypeConverter.StandardValuesCollection collection2 = listConverter.GetStandardValues(context);
			...
			if ((context != null) && (context.Container != null))
			{
				...
				{
					if (!dropDownItems.Contains(component) &&
						   ((component is System.Data.OleDb.OleDbCommand) ||
