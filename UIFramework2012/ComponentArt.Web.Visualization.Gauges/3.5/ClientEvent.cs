...
{
  /// <summary>
  /// Provides a type converter to convert a string to and from a <see cref="ClientEvent"/> object.
  /// </summary>
  [ToolboxItem(false)]
  internal class ClientEventConverter : TypeConverter
  {
        ...
        Type destinationType)
    {
      ...
      {
        return (value != null ? ((ClientEvent)value).EventHandler : "");
      }
  ...
  public class ClientEvent
  {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ClientEvent"/> class with the specified event handler.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the event handler for this object.
    /// </summary>
    [DefaultValue("")]
  ...
  /// <summary>
  /// Provides a type converter to expand a <see cref="ClientEvents"/> container in property view.
  /// </summary>
  [ToolboxItem(false)]
  internal class ClientEventsConverter : ExpandableObjectConverter
  {
    public override object ConvertTo(
        ITypeDescriptorContext context,
        CultureInfo culture,
