...
namespace ComponentArt.WinUI
{
	...
	internal
#endif
	 class ThumbnailListBox : System.Windows.Forms.UserControl
	{
		...
		//private bool listMoved = true;

		ArrayList items = new ArrayList();
		//ImageList m_chartsImageList;
		...
		public ThumbnailListBox()
		{
			...
			//this.m_chartsImageList = new System.Windows.Forms.ImageList();
			// 
			// m_chartsImageList
			// 
		...
		protected override void OnPaintBackground(PaintEventArgs pe)
		{
			...
			//region.Exclude(new Rectangle(2,2*itemHeight+2,Width-4,Height-hScrollBar1.Height-2*itemHeight));
		...
		private void PaintHint(Graphics g)
		{
			...
			if(highlighted < 0 /*|| highlighted > hints.Length*/)
			{
			...
			//g.DrawString(hints[highlighted],font,new SolidBrush(Color.Gray),rec);
		}
		...
		private void PaintItem(Graphics g,int index, int ix, int iy)
		{
			...
			g.TextRenderingHint = TextRenderingHint.AntiAliasGridFit;
			//g.DrawImage(bitMaps[index],x+sideMargin,y+topMargin,bmpWidth,bmpHeight);
			...
			//g.DrawRectangle(pen,x+2,y+2,itemWidth-4,itemHeight-4);
		...
		protected override void OnMouseMove ( System.Windows.Forms.MouseEventArgs e )
		{
            ...
            /*
			int xm = e.X/itemWidth;
			int ym = e.Y/itemHeight;
			//int item = hScrollBar1.Value + xm + ym*((Items.Count+1)/2);
			int item = (hScrollBar1.Value == -1 ? 0 : hScrollBar1.Value)*2 + xm * 2 + ym;
		...
		protected override void OnMouseDown ( System.Windows.Forms.MouseEventArgs e )
		{
			...
			int xm = e.X/itemWidth;
			int ym = e.Y/itemHeight;
			int item = (hScrollBar1.Enabled ? hScrollBar1.Value*2 : 0) + xm * 2 + ym;
			if(xm >= nx || ym>1 || ym<0 || xm<0)
				item = -1;
             * */
