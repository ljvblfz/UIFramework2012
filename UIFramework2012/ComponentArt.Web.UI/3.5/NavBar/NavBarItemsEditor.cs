...
{
  internal class NavBarItemsEditor : WindowsFormsComponentEditor
  {
    public override bool EditComponent(ITypeDescriptorContext context, object component, IWin32Window owner) 
    {
      ComponentArt.Web.UI.NavBar oControl = (ComponentArt.Web.UI.NavBar)component;
      ...
      try 
      {
        if (site != null) 
        {
          ...
          transaction = designerHost.CreateTransaction("BuildNavBar");
        ...
        try 
        {
          NavBarItemsEditorForm oEditorForm = new NavBarItemsEditorForm(oControl);
