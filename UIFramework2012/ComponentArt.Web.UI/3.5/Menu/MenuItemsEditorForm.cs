...
namespace ComponentArt.Web.UI
{
  ...
  internal class MenuItemsEditorForm : System.Windows.Forms.Form
  {
    ...
    private ComponentArt.Web.UI.Menu _navBar;
    ...
    private void LoadNodes(MenuItem oItem, TreeNode oTreeNode)
    {
      oTreeNode.Tag = oItem;

      foreach(MenuItem oChild in oItem.Items)
      {
    ...
    public MenuItemsEditorForm(ComponentArt.Web.UI.Menu oMenu)
    {
      InitializeComponent();
      ...
      foreach(MenuItem oRoot in Items)
      {
    ...
    private void InitializeComponent()
    {
      ...
      System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(MenuItemsEditorForm));
      ...
      this.Text = "ComponentArt Menu Designer";
    ...
    private void button4_Click(object sender, System.EventArgs e)
    {
      ...
      MenuItem oItem = (MenuItem)treeView1.SelectedNode.Tag;
    ...
    private void button5_Click(object sender, System.EventArgs e)
    {
      if(treeView1.SelectedNode != null)
      {
        ...
        {
          // we have a root
          oItem.ParentMenu.Items.Remove(oItem);
        }
        else
        {
          // we have a child
