...
namespace ComponentArt.Web.UI
{
  ...
  /// </summary>
  internal class TabStripTabsEditorForm : System.Windows.Forms.Form
  {
    ...
    private ComponentArt.Web.UI.TabStrip _tabStrip;
    ...
    public TabStripTabsEditorForm(ComponentArt.Web.UI.TabStrip oTabStrip)
    {
      InitializeComponent();
      ...
      foreach(TabStripTab oRoot in Tabs)
      {
    ...
    private void InitializeComponent()
    {
      ...
      System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(TabStripTabsEditorForm));
      ...
      this.Name = "TabStripTabsEditorForm";
      this.Text = "ComponentArt TabStrip Designer";
    ...
    {
      TabStripTab oItem = new TabStripTab();
      oItem.Text = "New Root";
      oItem.navigator = _tabStrip;
    ...
    private void button4_Click(object sender, System.EventArgs e)
    {
      ...
      TabStripTab oItem = (TabStripTab)treeView1.SelectedNode.Tag;

      TabStripTab oNewItem = new TabStripTab();
      oNewItem.Text = "New Item";

      oItem.Tabs.Add(oNewItem);
    ...
    private void button5_Click(object sender, System.EventArgs e)
    {
      if(treeView1.SelectedNode != null)
      {
        ...
        {
          // we have a root
          oItem.ParentTabStrip.Tabs.Remove(oItem);
        }
        else
        {
          // we have a child
          oItem.ParentTab.Tabs.Remove(oItem);
        }
