...
namespace ComponentArt.Web.UI
{
  ...
  public class ClientTemplate : Control
  {
    ...
    {                                
      return "['" + this.ID + "'," + ClientTemplate.TextToJsString(this) + "]";
    }

    internal static string TextToJsString(ClientTemplate clientTemplate)
    {
      return (clientTemplate == null || clientTemplate.Text == null) ? "null" : "'" + clientTemplate.Text.Replace("\n", "").Replace("\r", "").Replace("'", "\\'") + "'";
    }
  }
