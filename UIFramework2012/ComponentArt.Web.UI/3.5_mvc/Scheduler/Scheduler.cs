    ...
    protected override void OnLoad(EventArgs e)
    {
      ...
      if (!this.IsCallback)
      {
        if (ScriptManager.GetCurrent(Page) != null)
        {
          ...
          this.RegisterScriptForAtlas("ComponentArt.Web.UI.Scheduler.client_scripts.A577AB33.js");
          this.RegisterScriptForAtlas("ComponentArt.Web.UI.Scheduler.client_scripts.A577AB34.js");
        }
      }
