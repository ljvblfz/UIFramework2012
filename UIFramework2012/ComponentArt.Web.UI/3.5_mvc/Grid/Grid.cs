    ...
    */
    ...
    protected override void ComponentArtRender(HtmlTextWriter output)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          oSB.Append("['CallbackPrefix','" + (this.CallbackPrefix != "" ? this.CallbackPrefix : Utils.GetResponseUrl(Context).Replace("'", "\\'") + (Context.Request.QueryString.Count > 0 ? "&" : "?") + "Cart_" + sGridVar + "_Callback=yes") + "'],");
          ...
          {
            oSB.Append("['IsMvc',1],");
            oSB.Append("['MvcAjaxUrl'," + Utils.ConvertStringToJSString(MvcAjaxUrl) + "],");
          }
    ...
    protected override void OnLoad(EventArgs oArgs)
    {
      ...
      if (ScriptManager.GetCurrent(Page) != null)
      {
        ...
        this.RegisterScriptForAtlas("ComponentArt.Web.UI.Grid.client_scripts.A573R178.js");
        this.RegisterScriptForAtlas("ComponentArt.Web.UI.Grid.client_scripts.A573R378.js");
        this.RegisterScriptForAtlas("ComponentArt.Web.UI.Grid.client_scripts.A573G188.js");
        this.RegisterScriptForAtlas("ComponentArt.Web.UI.Grid.client_scripts.A573J198.js");
        this.RegisterScriptForAtlas("ComponentArt.Web.UI.Grid.client_scripts.A573L238.js");
      }
    }
