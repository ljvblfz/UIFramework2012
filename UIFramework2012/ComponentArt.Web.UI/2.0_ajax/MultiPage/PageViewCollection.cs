...
{
  /// <summary>
  /// Collection of <see cref="PageView"/> controls.
  /// </summary>
  ...
  public class PageViewCollection : ControlCollection
  {
    ...
    public new PageView this[int index]
    {
      get
      {
        return (PageView)base[index];
      }
    }
    ...
    public PageViewCollection(MultiPage owner)
      : base(owner)
    {
    }
    ...
    private void VerifyChild(Control child)
    {
      ...
      throw new Exception("Child is not a PageView");
    }
