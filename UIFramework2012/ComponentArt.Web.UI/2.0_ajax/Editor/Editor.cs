  ...
  public sealed class Editor : WebControl, INamingContainer
  {
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        if (ScriptManager.GetCurrent(Page) != null)
        {
          ...
          this.RegisterScriptForAtlas("ComponentArt.Web.UI.Editor.client_scripts.A572GI44.js");
          this.RegisterScriptForAtlas("ComponentArt.Web.UI.Editor.client_scripts.A572GI43.js");
          this.RegisterScriptForAtlas("ComponentArt.Web.UI.Editor.client_scripts.A572GI45.js");
          if (this.UseModernSkins())
          {
            this.RegisterScriptForAtlas("ComponentArt.Web.UI.Editor.client_scripts.A572GI46.js");
          }
        }
      }
