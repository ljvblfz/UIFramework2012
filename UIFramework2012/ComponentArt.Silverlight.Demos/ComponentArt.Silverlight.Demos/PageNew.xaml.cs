...
namespace ComponentArt.Silverlight.Demos
{
    ...
    [TemplatePart(Name = PageNew.Part_Menu, Type = typeof(Menu))]
    ...
    [TemplatePart(Name = PageNew.Part_TreeView, Type = typeof(ComponentArt.Silverlight.UI.Navigation.TreeView))]
    ...
    public partial class PageNew : UserControl
    {
        ...
        private ComponentArt.Silverlight.UI.Navigation.TreeView _treeView;
        private Menu _menu;
        ...
        private string _demoPath = "../Assets/Demo/";
        private string _demoXmlPath = "Assets/Demo/TreeViewXml/";
        private string _menuXmlPath = "Assets/Demo/Menu/Menu.xml";
        ...
        public PageNew()
        {
            ...
            _indexPages.Add("BestOfBreed_Visualization");
        }
        ...
        void PageNew_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            // Configure the Menu.
            String menuXml = "";
            using (XmlReader reader = XmlReader.Create(_menuXmlPath))
            {
            ...
            Dispatcher.BeginInvoke(()=> LoadDemo(initialDemo));
        }
        ...
        {
            _treeView = (ComponentArt.Silverlight.UI.Navigation.TreeView)FindName(Part_TreeView);
            _menu = (Menu)FindName(Part_Menu);
        ...
        private void DemoMenu_MenuClick(object sender, ComponentArt.Silverlight.UI.Navigation.MenuCommandEventArgs mce)
        {
        ...
        {
            ((MenuItem)DemoMenu.Items[8]).IsOpened = false;
        ...
        internal void NavigateToDemo(string action, string target)
        {
            switch (action)
            {
                case "control":
                    {
                        // update header image.
                        LoadHeaderImage(_demoPath+"ControlLogos/silverlight-logo-" + target.ToLower() + ".png");
                        ...
                        SelectTreeNode(FindFirstDemo(_treeView).Tag.ToString());
                        break;
                    }
                case "integration":
                    {
        ...
        /// <param name="tv"></param>
        /// <returns></returns>
        private TreeViewNode FindFirstDemo(ComponentArt.Silverlight.UI.Navigation.TreeView tv)
        {
        ...
        /// </summary>
        /// <param name="sDemo"></param>
        private void LoadDemoExclusive(string sDemo)
        {
            if (sDemo != null && sDemo != "")
            {
                _demoName = sDemo;
        ...
        {
            // check for live
            if ((Application.Current.Host != null
                && Application.Current.Host.Source != null)
                && Application.Current.Host.Source.Host.Contains("componentart.com"))
            {
                return true;
            }
            return false;
