...
namespace ComponentArt.Web.Visualization.Charting.Design
{
	...
	/// </summary>
	internal class EnumDescConverter : System.ComponentModel.EnumConverter
	{
		...
		bool m_convertingForInstanceDescriptor = false;

		public override object ConvertTo(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value, Type destinationType)
		{
			if(value is Enum && destinationType == typeof(string)) 
			{
				if (m_convertingForInstanceDescriptor)
			...
			{
				m_convertingForInstanceDescriptor = true;
			}
			...
			if (destinationType == typeof(InstanceDescriptor)) 
			{
				m_convertingForInstanceDescriptor = false;
			}
			return o;			
		}
